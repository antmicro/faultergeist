...
function(fi_add_fault_campaign NAME)
  ...
  _fi_resolve_implicit_arg_with_default(FAULT_CAMPAIGN_OUT "${FI_E2E_FAULT_CAMPAIGN_OUT_DEFAULT_FILENAME}" FI_SIMULATION_DIR)
  ...
  if(NOT FI_NO_VLT_CONFIG)
    _fi_resolve_implicit_arg_with_default(VLT_CONFIG "${FI_E2E_VLT_CONFIG_DEFAULT_FILENAME}" FI_SIMULATION_DIR)
...
function(fi_add_verilated_sim NAME)
  ...
  if(FI_NO_MAIN AND DEFINED SIM_MAIN_FILE AND NOT "${SIM_MAIN_FILE}" STREQUAL "")
    list(APPEND FI_SOURCES "${SIM_MAIN_FILE}")
  endif()
  if(DEFINED VERILATOR_EXTRA_ARGS AND NOT "${VERILATOR_EXTRA_ARGS}" STREQUAL "")
    _fi_default_arg(FI_VERILATOR_EXTRA_ARGS VERILATOR_EXTRA_ARGS)
  endif()
  _fi_resolve_implicit_arg_with_default(SIMULATION_DIR "${FI_E2E_VERILATOR_OUTPUT_DIR_DEFAULT_FILENAME}" WORK_DIR)
  _fi_resolve_implicit_arg_with_default(FAULT_CAMPAIGN_OUT "${FI_E2E_FAULT_CAMPAIGN_OUT_DEFAULT_FILENAME}" FI_SIMULATION_DIR)
  ...
  if(FI_FAULT_INJECTION)
    if(NOT FI_CAMPAIGN_FILE)
      _fi_resolve_implicit_arg_with_default(FAULT_CAMPAIGN_OUT fault_campaign_out.csv FI_SIMULATION_DIR)
...
function(fi_add_sim_run NAME)
  ...
  _fi_resolve_implicit_arg_with_default(SIMULATION_DIR "${FI_E2E_VERILATOR_OUTPUT_DIR_DEFAULT_FILENAME}" WORK_DIR)
  _fi_resolve_implicit_arg_with_default(TB_TOP "${FI_E2E_TB_TOP_DEFAULT_FILENAME}" "")
  _fi_resolve_implicit_arg_with_default(EXECUTABLE "${FI_TB_TOP}" FI_SIMULATION_DIR)
  _fi_resolve_implicit_arg_with_default(LOG run.log FI_SIMULATION_DIR)
  _fi_resolve_implicit_arg_with_default(VCD_OUTPUT_PATH "${FI_E2E_VCD_OUTPUT_PATH_DEFAULT_FILENAME}" "")
...
function(fi_add_multi_campaign_runs NAME)
  ...
  _fi_resolve_implicit_arg_with_default(SIMULATION_DIR "${FI_E2E_VERILATOR_OUTPUT_DIR_DEFAULT_FILENAME}" WORK_DIR)
  _fi_resolve_implicit_arg_with_default(CAMPAIGN_DIR "${FI_E2E_CAMPAIGN_DIR_DEFAULT_FILENAME}" FI_SIMULATION_DIR)
  _fi_resolve_implicit_arg_with_default(LOG_DIR logs FI_SIMULATION_DIR)
  _fi_default_arg(FI_WORK_DIR WORK_DIR)
